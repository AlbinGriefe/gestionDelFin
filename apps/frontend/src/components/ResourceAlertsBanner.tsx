...
export default function ResourceAlertsBanner() {
    ...
    const canSeeAlerts = user && ALERT_ROLES.includes(user.roleName);
    ...
    return (
        <div className={styles.banner}>
            <div className={styles.bannerHeader} onClick={() => setCollapsed(prev => !prev)}>
                ...
                <div className={styles.bannerActions}>
                    <button className={styles.refreshBtn} onClick={e => { e.stopPropagation(); fetchAlerts(); }}>
                        Actualizar
                    </button>
    ...
    return (
        <div className={styles.alertItem}>
            ...
            <div className={styles.alertQty}>
                ...
                <span className={styles.alertNumbers} style={{ color: isCritical ? "#A32D2D" : "#7A4500" }}>
