...
import type { ProfessionSummary, ProfessionWriteInput } from "../modules/professions/types/professions.types";
...
export default function ProfessionsPage() {
    ...
    const [selectedProfession, setSelectedProfession] = useState<ProfessionSummary | null>(null);
