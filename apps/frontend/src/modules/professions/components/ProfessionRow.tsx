...
export default function ProfessionRow({
  profession,
  onEdit,
}: ProfessionRowProps) {
            ...
            <div className={styles.detailGrid}>
              <DetailCard title="Producción diaria">
                <DetailField
                  ...
                  value={String(profession.foodGeneratedPerDay)}
                />
                <DetailField
                  label="Agua por día"
                  value={String(profession.waterGeneratedPerDay)}
                />
                <DetailField
                  label="Recolecta recursos"
                  value={profession.collectsResources ? "Sí" : "No"}
                />
              </DetailCard>
              ...
              <DetailCard title="Alcance">
                <DetailField
                  label="Ámbito"
                  value={
                    profession.campId === null
                      ? "Global (todos los campamentos)"
                      : `Campamento #${profession.campId}`
                  }
                />
                <DetailField
                  label="Estado"
                  value={profession.isActive ? "Activa" : "Inactiva"}
                />
