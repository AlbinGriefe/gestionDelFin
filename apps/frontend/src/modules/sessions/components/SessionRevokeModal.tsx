...
import type { SessionSummary, SessionRevokeInput } from "../types/sessions.types";
...
export default function SessionRevokeModal({ session, onConfirm, onClose }: SessionRevokeModalProps) {
            ...
            <div className={styles.modal} onClick={e => e.stopPropagation()}>
                ...
                <div className={styles.body}>
                    <p className={styles.warning}>
                        Esta acción cerrará la sesión de <strong>{session.user.username}</strong> en{" "}
                        <strong>{session.camp.name}</strong>. El usuario deberá iniciar sesión nuevamente.
                    </p>
