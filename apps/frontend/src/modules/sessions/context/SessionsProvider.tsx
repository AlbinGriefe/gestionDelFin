...
export function SessionsProvider({ children }: { children: React.ReactNode }) {
    ...
    const [pagination, setPagination] = useState<SessionList["pagination"] | null>(null);
    const [appliedFilters, setAppliedFilters] = useState<SessionList["appliedFilters"] | null>(null);
