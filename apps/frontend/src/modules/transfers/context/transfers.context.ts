...
export interface TransfersContextType {
    ...
    updateTransferState: (transferId: number, data: TransferStateUpdateInput) => Promise<TransferDetail>;
}

export const TransfersContext = createContext<TransfersContextType | null>(null);