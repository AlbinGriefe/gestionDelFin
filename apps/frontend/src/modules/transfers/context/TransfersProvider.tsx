...
export function TransfersProvider({ children }: { children: React.ReactNode }) {
  ...
  const [pagination, setPagination] = useState<
    TransfersList["pagination"] | null
  >(null);
  const [appliedTransfersFilters, setAppliedTransfersFilters] = useState<
    TransfersList["appliedFilters"] | null
  >(null);
  ...
  const [catalogsFilters, setCatalogsFilters] =
    useState<TransferCatalogFilters>({});
