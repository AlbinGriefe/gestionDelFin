...
export default function AdjustmentForm({
  ...
  const handleSubmit = async () => {
    ...
    if (mode === "set" && qty < 0)
      return setError("La cantidad establecida no puede ser negativa.");
          ...
          <div className={styles.modeGroup}>
            ...
            >
              ...
              <span className={styles.modeBtnDesc}>
                Suma o resta una cantidad al valor actual
              </span>
            </button>
            <button
              type="button"
                ...
                {selectedResource && (
                  <span className={styles.unit}>
                    ...
                    {isFixed
                      ...
                      : ((catalogs as InventoryCatalogs | null)?.resources.find(
                          (r) => r.id === Number(resourceId),
                        )?.unit ?? "")}
                  </span>
                )}
              </label>
