...
export default function InventoryList({
  ...
  const { inventories, loading, pagination, filters, setFilters, catalogs } =
    useInventory();
  ...
  const handleTypeFilter = (e: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    setFilters({
      ...filters,
      page: 1,
      resourceTypeId: val ? Number(val) : undefined,
    });
  };
  ...
  const toggleBelowMin = () => {
    setFilters({
      ...filters,
      page: 1,
      belowMinimum: filters.belowMinimum ? undefined : true,
    });
  };
  ...
  const togglePriority = () => {
    setFilters({
      ...filters,
      page: 1,
      priorityOnly: filters.priorityOnly ? undefined : true,
    });
  };
          ...
          {pagination && pagination.totalPages > 1 && (
            <div className={styles.pagination}>
              <span className={styles.paginationInfo}>
                ...
                {pagination.totalItems} recursos
              </span>
